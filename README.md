...
The sparse networks are obtained by [Sparse Evolutionary Training (SET)](https://www.nature.com/articles/s41467-018-04316-3.pdf) with their efficient [code](https://github.com/dcmocanu/sparse-evolutionary-artificial-neural-networks). SET proposed a novel concept, sparse neural networks with adaptive sparse connectivity to maintain sparsity during training, allowing training sparse neural networks from the beginning.
